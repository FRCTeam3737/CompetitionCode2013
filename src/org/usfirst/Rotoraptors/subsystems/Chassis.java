...
public class Chassis extends Subsystem {
    ...
    // Ignore the commented code, most of it isn't necessary and got caught on the
    // wrong side of our competition rush triage
...
//        rightMtrOut = rightMtr + skim(leftMtr); 
        drive.tankDrive(leftMtr * speedLimit * -1, rightMtr * speedLimit * -1);
    }
